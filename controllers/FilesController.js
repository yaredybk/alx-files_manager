...
export async function postUpload(req, res) {
  ...
  const parentId =
    body && body.parentId ? body.parentId : ROOT_FOLDER_ID;
  const isPublic = body && body.isPublic ? body.isPublic : false;
  const base64Data = body && body.data ? body.data : '';
  ...
  if (!body.data && type !== VALID_TYPES.folder) {
